            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {[['Our Story', '/about'], ['Portfolio', '/portfolio'], ['Blog', '/blog'], ['Contact', '/contact'], ['Client Login', '/login']].map(([label, href]) => (
                                <li key={href}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="font-inter text-sm text-white/50">+251 91 234 5678</span>
                            </li>
                            <li className="flex items-start gap-3">
